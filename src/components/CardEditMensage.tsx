...
export function CardEditMensage(props:cardMensage) {
    return (
            <Card className="w-[24.74rem] flex flex-col items-center">
                ...
                <CardFooter>
                    <Button variant="outline" className="w-[11.93rem] h-[3.125rem] text-green-400 border-green-400">Editar</Button>
                </CardFooter>
            </Card>
    )
}